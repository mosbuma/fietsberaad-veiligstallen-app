...
const LeftMenu: React.FC<LeftMenuProps> = ({
  ...
  const renderUnifiedMenu = () => {
    ...
    const hasDatabaseRight = isAdmin;
      ...
      <>
        ...
        { formatLi(false, 'Organisaties', false,
          <ul className="ml-4 mt-1">
            ...
            {!hasSystemRight && hasFmsModule && hasDataprovidersRight && formatLi(VSMenuTopic.ContactsDataproviders, 'Toegang fmsservice')}
          </ul>) }
        ...
        {hasSystemRight && formatLiDevelopment(VSMenuTopic.Settings, 'Instellingen')}

        {hasSystemRight && hasDatabaseRight && formatLi(VSMenuTopic.Database, 'Database')}
