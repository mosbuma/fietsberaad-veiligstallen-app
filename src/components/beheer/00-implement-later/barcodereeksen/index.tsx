...
const BarcodereeksenComponent: React.FC<{ type: "uitgifte-barcodes" | "sleutelhangers" | "fietsstickers" }> = ({ type }) => {
  const router = useRouter();
  const { ...query } = router.query;

  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-4">Barcodereeksen Module</h1>
